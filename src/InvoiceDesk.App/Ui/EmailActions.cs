...
public sealed class EmailActions(InvoiceService invoices, ProfileService profiles, InvoicePdfExporter pdf, Mailer mailer,
    ToastService toasts, Desktop desktop)
{
